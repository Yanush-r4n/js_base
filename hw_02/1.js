...
const positive = Number(prompt("Введи положительное число"));
const negative = Number(prompt("Введи отрицательное число"));
...
/* 
Оказывается, если в prompt ничего не вводить и нажать подтвердить, в переменную
кладется null.
*/